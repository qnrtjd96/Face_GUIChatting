...
public class ServerMonitor extends javax.swing.JFrame {
    ...
    void createListModel()
    {
        ...
        list_online_clients.setBorder(javax.swing.BorderFactory.createTitledBorder("접속한 인원"));
     ...
     * WARNING: 이코드는 수정하지마세요 다시 호출되서 사용하는 서버 UIㅇ입니다!!!
     */
    ...
    private void initComponents() {
        ...
        ta_monitor_clients.setBorder(javax.swing.BorderFactory.createTitledBorder("모니터링 하기"));
        ...
        lb_status.setText("server stop");
        lb_status.setBorder(javax.swing.BorderFactory.createTitledBorder("서버 상태"));
